...
import { notEkleAPI } from '../store/actions'; // notEkleAPI action'ını import et
...
export default function PostForm() {
  ...
  function onSubmit(data) {
    ...
    // Form verilerini | ile birleştirerek API'nin beklediği formatta body oluştur
    const yeniNotBody = `${data.g1}|${data.g2}|${data.g3}`;
    const yeniNot = { body: yeniNotBody };

    // Action'ı dispatch et
    dispatch(notEkleAPI(yeniNot));

    // Tüm notlar sayfasına yönlendir
    history.push('/notlar');
  }
